...
import {TumblrEmbeddedMediaDirective} from './attribute-directives/tumblr-embedded-media.directive';
...
@NgModule({
    declarations: [AppComponent, SidebarComponent, SettingsComponent, PostListComponent,
        ...
        TumblrEmbeddedMediaDirective, TumblrImageDirective, TumblrLinkDirective,
        ResponsiveMenuComponent, PostReblogsComponent,
